...
| Exchange | Link | Market Data | Spot Trading | Futures Trading | Demo / Testnet | Integration Progress |
| :--- | :---: | :---: | :---: | :---: | :---: | :--- |
| <img src="https://img.shields.io/badge/Binance-D4A017?style=flat-square&logo=binance&logoColor=black"/> | [API](https://binance.com) | `✓ Yes` | `✓ Yes` | `✓ Yes` | `✓ Yes` | `██████████` **100%** |
| <img src="https://img.shields.io/badge/Bybit-C9892A?style=flat-square"/> | [API](https://bybit.com) | `✓ Yes` | `✓ Yes` | `✓ Yes` | `✓ Yes` | `██████████` **100%** |
...
| <img src="https://img.shields.io/badge/Hyperliquid-22A38B?style=flat-square"/> | [API](https://hyperliquid.xyz) | `○ Planned` | `✕ No` | `✕ No` | `✓ Yes` | `██░░░░░░░░` **20%** |
